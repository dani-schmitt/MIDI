...
std::shared_ptr<MidiIpMidiDevice> MidiIpMidiDeviceTable::GetDevice(
...
_Use_decl_annotations_
std::shared_ptr<MidiIpMidiDevice> MidiIpMidiDeviceTable::GetDeviceById(
...
_Use_decl_annotations_
void MidiIpMidiDeviceTable::SetDevice(
    winrt::guid const& associationId,
    std::shared_ptr<MidiIpMidiDevice> device)
{
    TraceLoggingWrite(
...
_Use_decl_annotations_
void MidiIpMidiDeviceTable::RemoveDevice(
    winrt::guid const& associationId)
{
...
_Use_decl_annotations_
bool MidiIpMidiDeviceTable::IsUniqueIdentifierInUse(
