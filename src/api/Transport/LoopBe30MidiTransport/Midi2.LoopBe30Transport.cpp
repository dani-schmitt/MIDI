...
HRESULT
CMidi2LoopBe30Transport::Activate(
    REFIID Riid,
    void **Interface
)
{
    ...
    if (__uuidof(IMidiBidirectional) == Riid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2LoopBe30Bidi>(&midiBidi));
    ...
    else if (__uuidof(IMidiServiceTransportPluginMetadataProvider) == Riid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2LoopBe30PluginMetadataProvider>(&metadataProvider));
