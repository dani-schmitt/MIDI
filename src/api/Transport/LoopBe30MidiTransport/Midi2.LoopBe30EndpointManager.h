...
public:
    ...
    HRESULT DeleteEndpoint(
        _In_ std::shared_ptr<MidiLoopBe30DeviceDefinition>
    );
...
private:
    ...
    void CleanupDeviceDefinition(_In_ std::shared_ptr<MidiLoopBe30DeviceDefinition> definition)
    {
    ...
    std::vector<std::shared_ptr<MidiLoopBe30DeviceDefinition>> m_createdEndpoints;
